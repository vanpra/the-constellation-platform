create type public.app_permission as enum ('users.delete', 'user_roles.insert', 'user_roles.delete', 'user_roles.update', 'topics.insert', 'topics.delete', 'topics.update');
