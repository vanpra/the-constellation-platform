...
/**
* Clear all tables, policies and triggers
*/
...
create policy "Allow all select access" on public.posts;
create policy "Allow all select access" on public.posts;
create policy "Allow authorized update access" on public.posts;
create policy "Allow authorized insert access" on public.posts;
